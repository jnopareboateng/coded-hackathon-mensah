  ...
  return (
    <div className="space-y-3 p-4 bg-stone-50 border border-stone-200 rounded">
      ...
      <a
        ...
        className="flex items-center justify-center gap-2.5 w-full py-3 bg-[#25D366] text-white text-sm font-medium tracking-wide hover:bg-[#20b857] transition-colors"
      >
