...
describe('buildOrderMessage', () => {
  ...
  it('includes item name', () => {
    expect(buildOrderMessage(basket)).toContain('Outfit 1')
  })
  it('includes qty for multi-qty items', () => {
    expect(buildOrderMessage(basket)).toContain('Qty: 2')
  })
  it('includes total', () => {
  ...
  it('includes ORDER DETAILS section header', () => {
    expect(buildOrderMessage(basket)).toContain('ORDER DETAILS')
  })
  ...
  it('includes customer note under SPECIAL INSTRUCTIONS', () => {
